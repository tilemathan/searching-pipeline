...
def create_shfiles(sourcename, P_orb, WD_mass, Min_mass):
	...
	for beam in range (0, 1):
		...
		f.write("srun search-PSv2.py /hercules/u/tilemath/PILOT-SURVEY-DATA/"+sourcename+"/"+sourcename+"-"+"workdir"+beamstr+" /hercules/u/tilemath/PILOT-SURVEY-RESULTS/ACAJ/"+sourcename+"-"+"results"+beamstr+" /hercules/u/tilemath/PILOT-SURVEY-DATA/"+sourcename+"/"+sourcename+"_"+"0"+beamstr+"_8bit"+" "+P_orb+" "+WD_mass+" "+Min_mass)
		f.close()
