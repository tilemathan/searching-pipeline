...
"DEDISPERSION"
dmlistpath = "/u/tilemath/bin/pipeline2017/dmlist"
...
#	reader(filename2_full, workdir)
#       calc(filename2_full, P_orb_str, WD_mass_str, Min_mass_str)
#       search(workdir, 2)

#	reader(filename4_full, workdir)
#       calc(filename4_full, P_orb_str, WD_mass_str, Min_mass_str)
#       search(workdir, 4)
